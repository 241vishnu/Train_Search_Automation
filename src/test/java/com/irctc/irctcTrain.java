...
public class irctcTrain {
	...
	// verify method for the given page is correct or not by comparing title of the
	// page
	public void verify() {
	 ...
	 * driver.findElement(By.xpath("//span[@id=\"exampleModalLabel\"]/strong")).
	 * isDisplayed(); return(status); }
	 */
